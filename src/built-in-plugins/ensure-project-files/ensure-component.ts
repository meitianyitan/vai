...
import { componentEntry, docsPath, srcPath, vai } from '../../node';
import { prettierConfig } from '../../utils/prettier-config';
import { ensureTest } from './ensure-project';

export function ensureComponentFiles(instance: typeof vai) {
...
export function ensurePackageJson(instance: typeof vai) {
...
const ensureEntryFile = (instance: typeof vai) =>
  instance.project.addProjectFiles({
...
const ensureDocs = (instance: typeof vai) => {
